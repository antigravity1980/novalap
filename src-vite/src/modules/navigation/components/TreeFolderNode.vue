...
const children = computed(() => {
  const key = navigationStore.normalizePath(props.folder.path)
  return navigationStore.treeFolders[key] || []
})
const hasChildren = computed(() => props.folder.has_subfolders)
const isActive = computed(() => navigationStore.normalizePath(props.folder.path) === navigationStore.currentPath)
